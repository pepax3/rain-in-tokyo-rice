...
static const char *fonts[]          = {
  ...
  "CozetteVector:Medium:pixelsize=20:antialias=true"
};
static const char dmenufont[]       = "CozetteVectorNerdFont:Regular:pixelsize=19:antialias=true";//"Source Code Pro:Semibold:pixelsize=15:antialias:true";
